...
public class TaintTrackingMethodVisitor<T> extends MethodVisitor {
    ...
    public TaintTrackingMethodVisitor(InheritanceMap inheritanceMap, Map<MethodReference.Handle, Set<Integer>> passthroughDataflow, AnalyzerAdapter analyzerAdapter, int access, String name, String desc, String signature, String[] exceptions) {
        super(Opcode.ASM_V);
